...
def main(args):
    ...
    if args.extra_aug:  # UPDATED
        from torchvision import transforms  # UPDATED
        preprocess_train.transforms.insert(0, transforms.RandomAffine(degrees=(-30, 30)))  # UPDATED
        preprocess_train.transforms.insert(2, transforms.ColorJitter(0.2, 0.2))  # UPDATED
    if args.distill:
